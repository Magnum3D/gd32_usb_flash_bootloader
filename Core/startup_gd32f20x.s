/**
  ******************************************************************************
  * @file      startup_gd32f20x.s
  * @author    MCD Application Team
  * @brief     GD32F20x Devices vector table
...
g_pfnVectors:
  ...
  .word     RTC_IRQHandler                    /* RTC Wakeup through the EXTI line */
  .word     FMC_IRQHandler                    /* FLASH                        */
  .word     RCU_IRQHandler                    /* RCC                          */
  ...
  .word     ADC0_1_IRQHandler                 /* ADC1, ADC2 and ADC3s         */
  ...
  .word     ADC2_IRQHandler                   /* DMA1 Stream7                 */
  ...
  .word     TIMER5_IRQHandler                 /* TIM6 and DAC1&2 underrun errors */
  ...
  .word     DMA1_Channel5_IRQHandler          /* DMA2 Stream 6                */
  .word     DMA1_Channel6_IRQHandler          /* DMA2 Stream 7                */
  ...
  .word     CAU_IRQHandler                    /* Reserved                  */
  .word     HAU_TRNG_IRQHandler               /* Hash and Rng                 */
  .word     0
